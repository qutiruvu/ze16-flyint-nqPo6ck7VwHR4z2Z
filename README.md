.NET 团队在官方博客上发布了[.NET 10 RC2](https://github.com)[1], .NET 10 作为继 .NET 9 后的长期支持版本（LTS），提供3年官方支持。RC2 是正式版（GA）前的最终候选版本，已具备生产环境可用性（Go-Live License），支持企业级部署。.NET 10版本发布时间线
